...
4. If one has given 1 and true in a set and if we print its set it will give either of the value.
...
5. To print the names those who play only football.
6. To print the names those who play only cricket. 
7. End.

# Algorithm of Question-4
1. Start.
2. To create the set of names of all students.
